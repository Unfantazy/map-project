        ...
        return <div className='InfoBlock HintBlock'>
            <div className={'InfoBlock__wrapper'}>
                ...
                <div className="InfoBlock__inner scroller">
                    <div className={'HintBlock__text'}>Для получения атрибутов спортивной инфраструктуры или показателей обеспеченности населения
                        на определенной территории:</div>
                    <ul className={'HintBlock__list'}>
                        <li className={'HintBlock__item'}>1. На вкладке "Фильтры" определите критерии для требуемых спортивных объектов </li>
                        <li className={'HintBlock__item'}>2. На вкладке "Слои" выберите необходимую тепловую карту  </li>
                        <li className={'HintBlock__item'}>3. На вкладке "Инструменты" с помощью инструментов выделите необходимую область </li>
                    </ul>
                </div>
            </div>
        </div>
